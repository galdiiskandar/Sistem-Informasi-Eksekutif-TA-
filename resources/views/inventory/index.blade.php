  ...
  <section class="content">
    ...
    <div class="box">
      <div class="box-header with-border">
        <h3 class="box-title">Table Data Inventory</h3>
      </div>
      <div class="box-body">
      ...
      <form role="form" action="/inventory/store" method="post">
        <div class="box-body">
          ...
          <div class="form-group">
            ...
            <input type="text" autocomplete="off" class="form-control" id="add_product_serial_number" placeholder="Input product serial number" required="required" name="add_product_serial_number">
          </div>
          <div class="form-group">
            ...
            <input type="text" autocomplete="off" readonly class="form-control pull-right datepicker_purchase_date" id="add_purchase_date" required="required" name="add_purchase_date">
            </div>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <div class="form-group">
              <div>
                <input type="radio" name="add_condition" id="a_c_a" value="Very Good" class="flat-red a_c_a" checked>
                Very Good
              </div>
              <div>
                <input type="radio" name="add_condition" id="a_c_b" value="Good" class="flat-red a_c_a">
                Good
              </div>
              <div>
                <input type="radio" name="add_condition" id="a_c_c" value="Bad" class="flat-red a_c_a">
                Bad
              </div>
            </div>
          </div>
...
<script>
  ...
  jQuery(document).ready(function(){
    ...
    jQuery.ajax({
      ...
      method: 'post',
      data: {
        add_room_id: jQuery('#add_room_id').val(),
        add_product_name: jQuery('#add_product_name').val(),
        add_model: jQuery('#add_model').val(),
        add_product_serial_number: jQuery('#add_product_serial_number').val(),
        add_purchase_date: jQuery('#add_purchase_date').val(),
        add_condition: jQuery('.a_c_a:checked').val(),
        add_qty: jQuery('#add_qty').val(),
        add_information: jQuery('#add_information').val()
      },
